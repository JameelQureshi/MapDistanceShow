...
public class EmailManager : MonoBehaviour
{
    ...
    const string kSenderEmailAddress = "fareedtahir131@gmail.com";
    const string kSenderPassword = "ftloj713786131ft";
    const string kReceiverEmailAddress = "atifhabib308@gmail.com";
